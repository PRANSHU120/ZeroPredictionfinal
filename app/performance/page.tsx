...
export default function FullPerformancePage() {
  ...
  return (
    <main className="min-h-screen bg-[#F7FBF8] px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <a
          href="/"
          className="mb-6 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-extrabold text-forest shadow-sm transition hover:scale-[1.02]"
        >
          <ArrowLeft size={16} />
          Back to Home
        </a>

        <section className="overflow-hidden rounded-[2rem] border border-emerald-900/10 bg-white shadow-premium">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6">
                    Please check the Google Sheet publish-to-web CSV link or
                    contact support for the latest published records.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-emerald-900/10 bg-white p-6">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-2xl bg-mintSoft p-4 text-sm leading-6 text-charcoal/70">
                ...
                records are provided for process evaluation only; past
                performance is not a definitive indicator of future results.
              </div>
            </div>
          </div>
        </section>
